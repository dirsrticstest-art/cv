    ...
    <section id="certifications" className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        {certifications.map((cert, idx) => (
          <div
            key={idx}
            className="bg-gray-900/70 border border-gray-800 hover:border-purple-800/60 rounded-xl p-5 flex flex-col justify-between space-y-3 transition group shadow-sm"
          >
